...
export function IdeApp() {
  ...
  const studioStyle = { '--accent': colors.accent, '--accent-hover': colors.hover, '--selection': colors.selection, '--accent-subtle': colors.subtle, '--studio-bg': colors.background, '--studio-bg-secondary': colors.backgroundSecondary, '--surface': colors.surface, '--surface-elevated': colors.surfaceElevated, '--editor-bg': colors.editor, '--console-bg': colors.console, '--sidebar-bg': colors.sidebar, '--header-bg': colors.header, '--status-bg': colors.status, '--tab-bg': colors.tab, '--tab-active-bg': colors.tabActive, '--palette-border': colors.border, '--text-primary': colors.text, '--text-secondary': colors.textSecondary, '--background-opacity': settings.backgroundOpacity / 100, '--background-blur': `${settings.backgroundBlur}px`, '--background-darkness': settings.backgroundDarkness / 100, '--custom-background': backgroundUrl ? `url("${backgroundUrl}")` : 'none' } as CSSProperties
  return (
