...
export const metadata: Metadata = {
  title: 'Inscripción a Python Práctico | C.O.A.',
  description:
    'Completa el formulario de inscripción antes de comenzar el curso gratuito de Python Práctico.',
}
...
export default function PracticalPythonRegistrationPage() {
  return (
        ...
        <section className="bg-primary text-primary-foreground">
          <div className="mx-auto max-w-4xl px-4 py-14 text-center md:py-20">
            ...
            <h1 className="text-balance text-3xl font-extrabold md:text-4xl">
              Bienvenido al curso de Python Práctico
            </h1>
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-sm md:p-10">
            <div className="text-center">
              ...
              <p className="mx-auto mt-3 max-w-2xl text-pretty leading-relaxed text-muted-foreground">
                El formulario nos permitirá registrar tu participación, llevar el
                control del curso y preparar la emisión de certificados posteriormente.
              </p>
            </div>
            ...
            <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row">
              <a
                ...
                className="inline-flex h-10 items-center justify-center gap-2 rounded-md bg-accent px-6 text-sm font-semibold text-accent-foreground transition-colors hover:bg-accent/90"
              >
              ...
              <Link
                ...
                className="inline-flex h-10 items-center justify-center rounded-md border border-input bg-background px-6 text-sm font-semibold text-foreground transition-colors hover:bg-accent hover:text-accent-foreground"
              >
                Continuar al curso
              </Link>
            </div>
