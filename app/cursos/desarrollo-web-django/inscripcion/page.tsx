...
export const metadata: Metadata = {
  title: 'Inscripción a Desarrollo Web con Django | C.O.A.',
  description: 'Completa el formulario antes de comenzar el curso gratuito de desarrollo web profesional con Django.',
}
...
export default function DjangoRegistrationPage() {
  return (
      ...
      <main className="flex-1">
        <section className="bg-primary text-primary-foreground">
          <div className="mx-auto max-w-4xl px-4 py-14 text-center md:py-20">
            ...
            <h1 className="text-balance text-3xl font-extrabold md:text-4xl">Bienvenido al curso de Desarrollo de Aplicaciones Web Profesionales con Django</h1>
        ...
        <section className="mx-auto max-w-4xl px-4 py-12 md:py-16">
          <div className="rounded-2xl border border-border bg-card p-6 shadow-sm md:p-10">
            ...
            <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row">
              ...
              <Link href="/cursos/desarrollo-web-django/curso" className="inline-flex h-10 items-center justify-center rounded-md border border-input bg-background px-6 text-sm font-semibold text-foreground transition-colors hover:bg-accent hover:text-accent-foreground">Continuar al curso</Link>
            </div>
          </div>
        </section>
      </main>
