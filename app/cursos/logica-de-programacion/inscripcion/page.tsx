...
export const metadata: Metadata = {
  title: 'Inscripción a Lógica de Programación | C.O.A.',
  description:
    'Completa el formulario de inscripción antes de comenzar el curso gratuito de Lógica de Programación.',
}
...
export default function LogicCourseRegistrationPage() {
  return (
        ...
        <section className="bg-primary text-primary-foreground">
          <div className="mx-auto max-w-4xl px-4 py-14 text-center md:py-20">
            ...
            <h1 className="text-balance text-3xl font-extrabold md:text-4xl">
              Bienvenido al curso de Lógica de Programación
            </h1>
