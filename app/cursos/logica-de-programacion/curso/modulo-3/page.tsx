...
export const metadata: Metadata = {
  title: 'Módulo 3: Lógica y toma de decisiones | C.O.A.',
  description:
    'Módulo 3 del curso de Lógica de Programación: Lógica y toma de decisiones.',
}
...
const moduleThreeToc: ModuleTocItem[] = [
  ...
  { id: 'parte-2-de-la-comparacion-a-la-decision', label: 'Parte 2: Condiciones' },
  { id: 'parte-3-decisiones-simples-y-dobles', label: 'Parte 3: Decisiones' },
  { id: 'parte-4-combinar-condiciones', label: 'Parte 4: Operadores lógicos' },
  { id: 'parte-5-varias-alternativas', label: 'Parte 5: Alternativas' },
...
const moduleThreeDelivery = {
  fileName: 'Modulo3_Nombre_Apellido.pdf',
  items: [
    'Nombre completo',
    'Nombre del curso',
    'Módulo 3',
    'Las ocho partes del mini proyecto',
...
function getVisibleModuleContent() {
  const source = readFileSync(
    path.join(process.cwd(), 'content', 'modulo-3.md'),
    'utf8',
  )
  ...
  const answersStart = source.indexOf('## 65. Respuestas de la evaluación')
  const selfEvaluationStart = source.indexOf('## 66. Autoevaluación')
...
export default function LogicCourseModuleThreePage() {
      ...
      <main className="flex-1">
        <section className="bg-primary text-primary-foreground">
          <div className="mx-auto max-w-5xl px-4 py-10 md:py-14">
            <Link
              href="/cursos/logica-de-programacion/curso/modulo-2"
            ...
            <div className="mt-4 space-y-1 text-sm text-primary-foreground/80">
              <p>Materiales: Papel, lápiz y acceso opcional a una herramienta de diagramas</p>
              <p>Herramientas opcionales: PSeInt o diagrams.net</p>
            </div>
        ...
        <ModuleExperience
          moduleId="logica-programacion-modulo-3"
          moduleLabel="Módulo 3"
          items={moduleThreeToc}
          nextHref="/cursos/logica-de-programacion/curso/modulo-4"
        ...
        >
          <article className="space-y-10">
            {sections.map((section) => {
              ...
              const isMiniProject = /^## (4[8-9]|5[0-2])\./.test(heading)
              const isEvaluation = /^## 64\./.test(heading)
